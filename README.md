...
The results of this analysis, as netcdfs, can be accessed at Zenodo: https://doi.org/10.5281/zenodo.7889165. If using the datasets, please cite using:

    Burton, Chad, Renzullo, Luigi, Rifai, Sami, Van Dijk, Albert, 2023. AusEFlux: Empirical upscaling of OzFlux eddy covariance flux tower data over Australia. https://doi.org/10.5281/zenodo.7889165
